...
global_innate_abilities <- 'OWNTEMPO,LIMBER'
...
## Keep columns
keep_cols <- c('Name','BaseStats','Types','Abilities','HiddenAbilities','Innates','Pokedex','Category','Evolutions','WildItemCommon','WildItemUncommon','Moves','GenderRatio','GrowthRate','BaseExp','EVs','CatchRate','Happiness','FormName','Height','Weight','EggGroups','HatchSteps')
