...
## Keep columns
keep_cols <- c('Name','BaseStats','Types','Abilities','HiddenAbilities','Pokedex','Category','Evolutions','WildItemCommon','WildItemUncommon','Moves','GenderRatio','GrowthRate','BaseExp','EVs','CatchRate','Happiness','FormName')
