...
## Keep columns
keep_cols <- c('Name','BaseStats','Types','Abilities','HiddenAbilities','Pokedex','Category','Evolutions','WildItemCommon','WildItemUncommon','Moves','GenderRatio','GrowthRate')
...
for (i in 1:nrow(excel_only_pkmn)) {
  header <- data.frame(Output = c("#-------------------------------",paste0("[",toupper(excel_only_pkmn$Name[i]),"]",sep=""),paste0("Name = ",excel_only_pkmn$Name[i],sep="")))
