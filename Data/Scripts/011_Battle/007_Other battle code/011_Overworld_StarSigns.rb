# Formally known as Overworld_Time
...
def moonphase_day(time = nil)
  ...
  v = (j - 2_451_550.1) / 29.530588853
  v = ((v - v.floor) + (v < 0 ? 1 : 0))
  ag = (v * 29.53).round  # Rounded moon day number
  #ag = (v * 29.53).ceil
  return ag
end

def moonphase_name(moonphase)
  moon_phases = [
  "New Moon","Waxing Crescent","First Quarter","Waxing Gibbous","Full Moon","Waning Gibbous","Last Quarter","Waning Crescent"
  ]
  return moon_phases[moonphase]
end
...
## MOON PHASE BONUS (active) UI
def moon_bonus_text(moon_index)
  moon_bonus_list = ["Speed","Attack","Special Attack","Evasion","Accuracy","Defense","Special Defense","Immunity","Critical Hits","Speed","Evasion","Accuracy","Defense","Special Defense","Immunity","Special Attack","Attack","Speed","Critical Hits","Evasion","Defense","Special Defense","Immunity","Accuracy","Special Attack","Attack","Evasion","Critical Hit Rate"]
  return moon_bonus_list[moon_index]
end

def moon_zodiac_sign(time = nil)
  time = pbGetTimeNow if !time
  ...
  # Calculate the number of days since the reference date (JDN 2,451,550.1)
  moon_age = (j - 2_451_550.1) / 29.530588853

  # Convert the moon age to degrees (0 to 360)
  moon_position_degrees = (moon_age * 360) % 360

  # Zodiac signs in order
  zodiac_signs = ["Aries", "Taurus", "Gemini", "Cancer", "Leo", "Virgo", "Libra", "Scorpio", "Sagittarius", "Capricorn", "Aquarius", "Pisces"]

  # Map degrees to zodiac signs
  sign_index = (moon_position_degrees / 30.0).floor % 12
